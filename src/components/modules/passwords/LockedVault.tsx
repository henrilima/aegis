    ...
    <div className="h-full w-full flex items-center justify-center bg-background p-6 ">
      <Card className="w-full max-w-sm bg-card border border-border rounded-xl overflow-hidden animate-in fade-in zoom-in-95 duration-500">
        <CardHeader className="text-center pt-10 pb-6">
          <div
            className={cn(
              "mx-auto mb-6 p-4 rounded-xl w-fit border",
              theme.bg,
              theme.border,
            )}
          >
            <Shield className={cn("w-8 h-8", theme.text)} />
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <Input
                ...
                className={cn(
                  "pl-12 h-11 bg-card border-border rounded-xl text-sm font-medium placeholder:text-neutral-700 transition-all",
        ...
        <CardFooter className="pb-10 pt-8 px-10 border-t border-border">
          <div className="text-center space-y-4">
            ...
            <p
              className={cn(
                "text-[10px] font-medium italic opacity-60",
                theme.text,
              )}
            >
