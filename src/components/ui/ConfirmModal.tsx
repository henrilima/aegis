...
> = {
  danger: {
    ...
    btnClass: "bg-red-500/10 border-red-500/40 hover:border-red-400 text-red-300 hover:text-red-200",
  ...
  warning: {
    ...
    btnClass: "bg-amber-500/10 border-amber-500/40 hover:border-amber-400 text-amber-300 hover:text-amber-200",
  ...
  default: {
    ...
    btnClass: "bg-blue-500/10 border-blue-500/40 hover:border-blue-400 text-blue-300 hover:text-blue-200",
...
export function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-60 flex items-center justify-center bg-black/85 backdrop-blur-md p-4 animate-in fade-in duration-300">
      <div className="w-full max-w-sm bg-neutral-950 border border-neutral-800 rounded-[2rem] overflow-hidden animate-in zoom-in-95 duration-300 text-center flex flex-col items-center shadow-2xl">
        <div
          className={`w-full py-10 flex justify-center ${cfg.bgColor} border-b border-neutral-800/50`}
        >
          <div
            className={`p-4 bg-neutral-950 border border-neutral-800 rounded-2xl w-fit ${cfg.iconColor}`}
          >
