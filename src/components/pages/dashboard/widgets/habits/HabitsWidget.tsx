      ...
      <div className="flex items-center gap-[5cqw] @sm:gap-7 mb-[5cqw] @sm:mb-5">
        <div className="relative shrink-0 w-[20cqw] h-[20cqw] min-w-[75px] min-h-[75px] max-w-[150px] max-h-[150px]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center">
            <span className="text-[4cqw] @sm:text-xl font-bold text-teal-600 dark:text-teal-400 leading-none min-text-[13px]">
              {progressPct}%
            </span>
          </div>
        </div>
        <div className="flex flex-col">
          ...
          <div className="flex items-center gap-1.5 mt-2">
            <Flame className="w-[4cqw] h-[4cqw] @sm:w-4 @sm:h-4 text-orange-600 dark:text-orange-400" />
