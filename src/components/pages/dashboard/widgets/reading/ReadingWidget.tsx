...
import type {
  ReadingBook,
  ReadingSession,
} from "@/components/pages/reading/types";
              ...
              return (
                ...
                >
                  <div className="flex items-start gap-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-orange-500/70 shrink-0 mt-1.5" />
                    <div className="flex-1 min-w-0">
                      <p className="text-[3cqw] @sm:text-xs font-semibold text-foreground truncate">
                        {book.title}
                      </p>
                    </div>
                    <span className="text-[2.5cqw] @sm:text-[10px] font-bold text-orange-600 dark:text-orange-400 bg-orange-400/10 px-1.5 py-0.5 rounded-md whitespace-nowrap shrink-0">
                      {progress}%
                    </span>
                  </div>
          ...
          <div className="space-y-[1.5cqw] @sm:space-y-1.5">
            {recentSessions.slice(0, 3).map((s, i) => (
              ...
              >
                ...
                <span className="text-[2.5cqw] @sm:text-[10px] font-bold text-orange-600 dark:text-orange-400 bg-orange-400/10 px-1.5 py-0.5 rounded-md whitespace-nowrap">
                  {s.pages_read} pág.
                </span>
              </div>
            ))}
