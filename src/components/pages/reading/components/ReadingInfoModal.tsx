      ...
      <div className="relative w-full max-w-2xl bg-background border border-border rounded-xl animate-in zoom-in-95 duration-200 overflow-hidden flex flex-col max-h-[90vh]">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Guia para gestão literária e metas de leitura
              </p>
            </div>
          </div>
          <button
        ...
        <div className="p-8 overflow-y-auto custom-scrollbar flex flex-col gap-8">
          ...
          <section className="space-y-4">
            ...
            <div className="bg-card/50 border border-border/50 rounded-xl p-4 space-y-3">
              <p className="text-sm text-muted-foreground leading-relaxed">
                Adicione os livros que você está lendo ou pretende ler. Use a
                busca automática para preencher dados:
              </p>
              <ul className="grid grid-cols-1 md:grid-cols-2 gap-3">
                {[
                  {
                    label: "Open Library",
                    desc: "Busca automática de capas e dados",
                  },
                  {
                    label: "Status",
                    desc: "Organize por Lendo, Lido ou Quero Ler",
                  },
                  {
                    label: "Progresso",
                    desc: "Acompanhe a página atual de cada obra",
                  },
                  {
                    label: "Categorias",
                    desc: "Classifique seus livros por gênero",
                  },
                ].map((item) => (
                  <li
                    key={item.label}
          ...
          <section className="space-y-4">
            ...
            <div className="bg-card/50 border border-border/50 rounded-xl p-4">
              <p className="text-sm text-muted-foreground leading-relaxed">
                Ao terminar uma sessão, registre o tempo e as páginas lidas. O
                sistema calculará:
              </p>
          ...
          <div className="bg-orange-600/10 border border-orange-600/20 rounded-xl p-4 flex gap-4">
            ...
            <div>
              ...
              <p className="text-[11px] text-muted-foreground mt-1 leading-relaxed">
                ...
                para criar um hábito sólido. O Aegis monitora seu progresso e
                avisa o quanto falta para bater seu objetivo.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6 border-t border-border/60 bg-card/30 flex justify-end">
          <button
            type="button"
            onClick={onClose}
            className="px-6 py-2 rounded-xl bg-orange-600 hover:bg-orange-500 text-foreground text-xs font-bold transition-all active:scale-95 cursor-pointer"
          >
            Entendido, boa leitura!
          </button>
        </div>
      </div>
    </div>
