      ...
      <div className="flex items-center justify-between gap-4">
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-11 h-12 bg-card/50 border-border focus-visible:ring-orange-500/20 rounded-xl border-b-2 border-b-neutral-800 placeholder:text-neutral-700"
          />
        </div>
      </div>
            ...
            >
              ...
              {s.note && (
                <div className="relative pl-6 py-1">
                  <div className="absolute left-1 top-0 bottom-0 w-px border-l-2 border-dotted border-orange-500/40" />
