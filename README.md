# 🛡️ Aegis - Seu Centro de Produtividade & Privacidade (v3.6.0 "Chroma")
...
Para conferir o histórico de novidades, melhorias e correções de cada versão, consulte o [changelog.md](changelog.md).
